    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-md bg-blue-50 p-4 text-sm text-blue-900 border border-blue-200">
                <strong>Note:</strong> Permissions are currently defined by system policies. To change a user's role, please visit the <a href="/users" className="underline hover:text-blue-700">User Management</a> page.
            </div>
        </div>
    );
}
